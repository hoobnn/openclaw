...
export const th: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "สรุปกิจกรรมเครื่องมือเฉพาะในเบราว์เซอร์",
  ...
  activity: {
    title: "กิจกรรม",
    subtitle: "กิจกรรมเครื่องมือชั่วคราวที่ได้จากเหตุการณ์เซสชันสด",
    ...
    clear: "ล้าง",
    empty: "ยังไม่มีกิจกรรมเครื่องมือ",
    ...
    streamLabel: "รายการกิจกรรมเครื่องมือ",
    toolCallId: "การเรียกเครื่องมือ",
    runId: "รัน",
    session: "เซสชัน",
  ...
  workboard: {
    ...
    openLinkedSession: "เปิดเซสชันที่เชื่อมโยง",
    deleteCard: "ลบการ์ด",
    defaultAgent: "เอเจนต์เริ่มต้น",
    live: "สด",
    dropWorkHere: "วางงานที่นี่",
    allPriorities: "ลำดับความสำคัญทั้งหมด",
    newCard: "การ์ดใหม่",
    start: "เริ่ม",
    startDefaultAgent: "เรียกใช้เอเจนต์เริ่มต้น",
    startAutonomousEngine: "เรียกใช้ {engine}",
    startManualEngine: "เปิด {engine}",
    fieldTitle: "ชื่อ",
    fieldNotes: "บันทึก",
    fieldStatus: "สถานะ",
    ...
    gameContinue: "ไปต่อ",
    gameWin: "เคลียร์การเปิดตัวแล้ว",
    gameMoves: "จำนวนการเดิน {count}",
    gameWins: "จำนวนครั้งที่ชนะ {count}",
    gameBoard: "กระดาน Card Chase",
    gameControls: "การควบคุม Card Chase",
    gameAgent: "เอเจนต์",
    gameLaunch: "เปิดตัว",
