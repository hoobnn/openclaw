...
export const pt_BR: TranslationMap = {
  ...
  activity: {
    ...
    runId: "Executar",
    session: "Sessão",
    outputTruncated: "Prévia editada e truncada.",
  ...
  workboard: {
    ...
    live: "ao vivo",
    dropWorkHere: "Solte o trabalho aqui",
    allPriorities: "Todas as prioridades",
    newCard: "Novo cartão",
    start: "Iniciar",
    startDefaultAgent: "Executar agente padrão",
    startAutonomousEngine: "Executar {engine}",
