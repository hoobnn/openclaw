...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Riepiloghi dell’attività degli strumenti locali del browser.",
  ...
  activity: {
    title: "Attività",
    subtitle: "Attività effimera degli strumenti derivata dagli eventi di sessione in tempo reale.",
    ...
    clear: "Cancella",
    empty: "Nessuna attività degli strumenti al momento.",
    ...
    streamLabel: "Voci attività degli strumenti",
  ...
  workboard: {
    ...
    live: "live",
    dropWorkHere: "Rilascia il lavoro qui",
    allPriorities: "Tutte le priorità",
    newCard: "Nuova scheda",
    start: "Avvia",
    startDefaultAgent: "Esegui agente predefinito",
    startAutonomousEngine: "Esegui {engine}",
    startManualEngine: "Apri {engine}",
    fieldTitle: "Titolo",
    fieldNotes: "Note",
    fieldStatus: "Stato",
