...
export const uk: TranslationMap = {
  ...
  activity: {
    title: "Активність",
    subtitle: "Тимчасова активність інструментів, отримана з подій сеансу наживо.",
    ...
    autoFollow: "Автовідстеження",
    expandAll: "Розгорнути все",
    collapseAll: "Згорнути все",
    clear: "Очистити",
    empty: "Активності інструментів ще немає.",
    ...
    runId: "Запустити",
    session: "Сеанс",
    outputTruncated: "Попередній перегляд заредаговано й обрізано.",
    noOutputPreview: "Немає попереднього перегляду виводу.",
    status: {
      running: "Запущено",
      done: "Готово",
      error: "Помилка",
  ...
  workboard: {
    ...
    openLinkedSession: "Відкрити пов’язаний сеанс",
    deleteCard: "Видалити картку",
    defaultAgent: "стандартний агент",
    live: "наживо",
    dropWorkHere: "Перетягніть роботу сюди",
    allPriorities: "Усі пріоритети",
    newCard: "Нова картка",
    start: "Почати",
    startDefaultAgent: "Запустити стандартний агент",
    startAutonomousEngine: "Запустити {engine}",
    startManualEngine: "Відкрити {engine}",
