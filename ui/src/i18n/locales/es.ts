...
export const es: TranslationMap = {
  ...
  activity: {
    title: "Actividad",
    subtitle: "Actividad efímera de herramientas derivada de eventos de sesiones en vivo.",
  ...
  workboard: {
    ...
    live: "en vivo",
    dropWorkHere: "Suelta el trabajo aquí",
    allPriorities: "Todas las prioridades",
    newCard: "Nueva tarjeta",
    start: "Iniciar",
    startDefaultAgent: "Ejecutar agente predeterminado",
    startAutonomousEngine: "Ejecutar {engine}",
    startManualEngine: "Abrir {engine}",
    fieldTitle: "Título",
    fieldNotes: "Notas",
    fieldStatus: "Estado",
