...
export const fa: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "خلاصه‌های فعالیت ابزارِ محلیِ مرورگر.",
  ...
  activity: {
    title: "فعالیت",
    subtitle: "فعالیت موقت ابزار که از رویدادهای زندهٔ جلسه به‌دست آمده است.",
    visibleCount: "{visible} از {total}",
    filtersLabel: "فیلترهای فعالیت",
    search: "جستجو",
    searchPlaceholder: "فیلتر بر اساس ابزار، خلاصه، اجرا، جلسه",
    toolFilter: "ابزار",
    ...
    argumentHiddenOne: "۱ آرگومان پنهان شد",
    argumentsHidden: "{count} آرگومان پنهان شد",
  ...
  workboard: {
    ...
    openLinkedSession: "باز کردن جلسهٔ پیوندشده",
    deleteCard: "حذف کارت",
    defaultAgent: "عامل پیش‌فرض",
    live: "زنده",
    dropWorkHere: "کار را اینجا رها کنید",
    allPriorities: "همهٔ اولویت‌ها",
    newCard: "کارت جدید",
    start: "شروع",
    startDefaultAgent: "اجرای عامل پیش‌فرض",
    startAutonomousEngine: "اجرای {engine}",
    startManualEngine: "باز کردن {engine}",
    fieldTitle: "عنوان",
