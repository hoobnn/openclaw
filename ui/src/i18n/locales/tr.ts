...
export const tr: TranslationMap = {
  ...
  activity: {
    ...
    search: "Ara",
    searchPlaceholder: "Araç, özet, çalıştırma, oturum ile filtrele",
    toolFilter: "Araç",
    ...
    argumentHiddenOne: "1 argüman gizli",
    argumentsHidden: "{count} argüman gizli",
    streamLabel: "Araç etkinliği girdileri",
    toolCallId: "Araç çağrısı",
    runId: "Çalıştır",
    session: "Oturum",
    outputTruncated: "Önizleme düzeltilmiş ve kısaltılmıştır.",
  ...
  workboard: {
    ...
    openLinkedSession: "Bağlı oturumu aç",
    deleteCard: "Kartı sil",
    defaultAgent: "varsayılan ajan",
    live: "canlı",
    dropWorkHere: "İşi buraya bırak",
    allPriorities: "Tüm öncelikler",
    newCard: "Yeni kart",
    start: "Başlat",
    startDefaultAgent: "Varsayılan ajanı çalıştır",
    startAutonomousEngine: "{engine} çalıştır",
    startManualEngine: "{engine} aç",
    fieldTitle: "Başlık",
    fieldNotes: "Notlar",
    fieldStatus: "Durum",
