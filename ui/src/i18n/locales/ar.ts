...
export const ar: TranslationMap = {
  ...
  workboard: {
    ...
    live: "مباشر",
    dropWorkHere: "أفلِت العمل هنا",
    allPriorities: "كل الأولويات",
    newCard: "بطاقة جديدة",
    start: "بدء",
    startDefaultAgent: "تشغيل الوكيل الافتراضي",
    startAutonomousEngine: "تشغيل {engine}",
    startManualEngine: "فتح {engine}",
    fieldTitle: "العنوان",
    fieldNotes: "ملاحظات",
    fieldStatus: "الحالة",
