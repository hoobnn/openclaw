...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "ブラウザーローカルのツールアクティビティ概要。",
  ...
  activity: {
    title: "アクティビティ",
    subtitle: "ライブセッションイベントから生成された一時的なツールアクティビティ。",
    visibleCount: "{visible} / {total}",
    filtersLabel: "アクティビティフィルター",
    search: "検索",
    searchPlaceholder: "ツール、概要、実行、セッションでフィルター",
    toolFilter: "ツール",
    allTools: "すべてのツール",
    ...
    argumentHiddenOne: "1 件の引数を非表示",
    argumentsHidden: "{count} 件の引数を非表示",
    streamLabel: "ツールアクティビティエントリ",
    toolCallId: "ツール呼び出し",
    runId: "実行",
    session: "セッション",
    outputTruncated: "プレビューは墨消しされ、切り詰められています。",
  ...
  workboard: {
    ...
    live: "ライブ",
    dropWorkHere: "ここに作業をドロップ",
    allPriorities: "すべての優先度",
    newCard: "新しいカード",
    start: "開始",
    startDefaultAgent: "デフォルトエージェントを実行",
    startAutonomousEngine: "{engine} を実行",
    startManualEngine: "{engine} を開く",
    fieldTitle: "タイトル",
    fieldNotes: "メモ",
    fieldStatus: "ステータス",
    fieldPriority: "優先度",
