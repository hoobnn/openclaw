...
export const pl: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Lokalne dla przeglądarki podsumowania aktywności narzędzi.",
  ...
  activity: {
    ...
    emptyFiltered: "Brak aktywności pasującej do tych filtrów.",
    ...
    runId: "Uruchom",
    session: "Sesja",
    outputTruncated: "Podgląd ocenzurowany i skrócony.",
    noOutputPreview: "Brak podglądu danych wyjściowych.",
    status: {
      running: "Uruchomiono",
      done: "Gotowe",
      error: "Błąd",
  ...
  workboard: {
    ...
    defaultAgent: "agent domyślny",
    live: "na żywo",
    dropWorkHere: "Upuść pracę tutaj",
    allPriorities: "Wszystkie priorytety",
    newCard: "Nowa karta",
    start: "Uruchom",
    startDefaultAgent: "Uruchom agenta domyślnego",
    startAutonomousEngine: "Uruchom {engine}",
    startManualEngine: "Otwórz {engine}",
    fieldTitle: "Tytuł",
    fieldNotes: "Notatki",
    fieldStatus: "Status",
