...
export const nl: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Browser-lokale samenvattingen van toolactiviteit.",
  ...
  activity: {
    ...
    search: "Zoeken",
    searchPlaceholder: "Filteren op tool, samenvatting, run, sessie",
    toolFilter: "Tool",
    allTools: "Alle tools",
    ...
    streamLabel: "Toolactiviteitsitems",
    toolCallId: "Toolaanroep",
    runId: "Voer uit",
    session: "Sessie",
    outputTruncated: "Voorbeeld geredigeerd en ingekort.",
  ...
  workboard: {
    ...
    live: "live",
    dropWorkHere: "Werk hier neerzetten",
    allPriorities: "Alle prioriteiten",
    newCard: "Nieuwe kaart",
    start: "Starten",
    startDefaultAgent: "Standaardagent uitvoeren",
    startAutonomousEngine: "{engine} uitvoeren",
    startManualEngine: "{engine} openen",
    fieldTitle: "Titel",
    fieldNotes: "Notities",
    fieldStatus: "Status",
    ...
    gameControls: "Card Chase-besturing",
    gameAgent: "Agent",
    gameLaunch: "Lancering",
