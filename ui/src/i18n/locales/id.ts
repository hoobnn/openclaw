...
export const id: TranslationMap = {
  ...
  activity: {
    ...
    search: "Cari",
    searchPlaceholder: "Filter berdasarkan alat, ringkasan, eksekusi, sesi",
    toolFilter: "Alat",
    allTools: "Semua alat",
    statusFilters: "Filter status",
    autoFollow: "Ikuti otomatis",
    expandAll: "Luaskan semua",
    ...
    runId: "Jalankan",
    session: "Sesi",
    outputTruncated: "Pratinjau disamarkan dan dipotong.",
  ...
  workboard: {
    ...
    live: "langsung",
    dropWorkHere: "Letakkan pekerjaan di sini",
    allPriorities: "Semua prioritas",
    newCard: "Kartu baru",
    start: "Mulai",
    startDefaultAgent: "Jalankan agen default",
    startAutonomousEngine: "Jalankan {engine}",
    startManualEngine: "Buka {engine}",
    fieldTitle: "Judul",
    fieldNotes: "Catatan",
    fieldStatus: "Status",
