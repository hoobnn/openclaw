...
export const de: TranslationMap = {
  ...
  activity: {
    ...
    streamLabel: "Tool-Aktivitätseinträge",
  ...
  workboard: {
    ...
    live: "live",
    dropWorkHere: "Arbeit hier ablegen",
    allPriorities: "Alle Prioritäten",
    newCard: "Neue Karte",
    start: "Starten",
    startDefaultAgent: "Standard-Agent ausführen",
    startAutonomousEngine: "{engine} ausführen",
    startManualEngine: "{engine} öffnen",
    fieldTitle: "Titel",
    fieldNotes: "Notizen",
    fieldStatus: "Status",
