...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Résumés de l’activité des outils locaux au navigateur.",
  ...
  activity: {
    ...
    runId: "Exécuter",
    session: "Session",
    outputTruncated: "Aperçu expurgé et tronqué.",
  ...
  workboard: {
    ...
    live: "en direct",
    dropWorkHere: "Déposer le travail ici",
    allPriorities: "Toutes les priorités",
    newCard: "Nouvelle carte",
    start: "Démarrer",
    startDefaultAgent: "Exécuter l’agent par défaut",
    startAutonomousEngine: "Exécuter {engine}",
    startManualEngine: "Ouvrir {engine}",
    fieldTitle: "Titre",
    fieldNotes: "Notes",
    fieldStatus: "Statut",
