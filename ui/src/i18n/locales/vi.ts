...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Tóm tắt hoạt động công cụ cục bộ trong trình duyệt.",
  ...
  activity: {
    title: "Hoạt động",
    subtitle: "Hoạt động công cụ tạm thời được tạo từ các sự kiện phiên trực tiếp.",
    visibleCount: "{visible} trong tổng số {total}",
    ...
    runId: "Chạy",
    session: "Phiên",
    outputTruncated: "Bản xem trước đã được biên tập và cắt bớt.",
  ...
  workboard: {
    ...
    live: "trực tiếp",
    dropWorkHere: "Thả công việc vào đây",
    allPriorities: "Tất cả mức độ ưu tiên",
    newCard: "Thẻ mới",
    start: "Bắt đầu",
    startDefaultAgent: "Chạy tác tử mặc định",
    startAutonomousEngine: "Chạy {engine}",
    startManualEngine: "Mở {engine}",
    fieldTitle: "Tiêu đề",
    fieldNotes: "Ghi chú",
    ...
    gameStart: "Đi tới ô khởi chạy.",
    gameBoundary: "Đã chạm ranh giới.",
    gameBlocked: "Bị chặn.",
    gameContinue: "Tiếp tục.",
    gameWin: "Đã hoàn tất khởi chạy.",
    gameMoves: "Lượt di chuyển {count}",
    gameWins: "Lượt thắng {count}",
